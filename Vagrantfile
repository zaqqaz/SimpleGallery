...
Vagrant.configure("2") do |config|
    ...
    if which('ansible-playbook')
        ...
        config.vm.provision "ansible" do |ansible|
            ...
            ansible.sudo = true
            ansible.limit = 'simplegallery'
            ansible.groups = {"vagrant" => ["simplegallery"] }
        end
    else
        config.vm.provision :shell, path: "ansible/windows.sh", args: ["simplegallery.vagrant"]
    end
	...
	config.vm.define 'simplegallery' do |node|
	    node.vm.hostname = 'simplegallery.vagrant'
    	node.hostmanager.aliases = %w(simplegallery.vagrant)
	end
